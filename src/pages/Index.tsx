          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-cream-dark leading-relaxed mb-5 font-light">
                «Своя мелодия» — это закрытая профессиональная группа для практикующих психотерапевтов. Здесь каждый специалист может принести сложный случай, усталость от работы или профессиональный вопрос — и получить поддержку коллег.
              </p>
              <p className="text-cream-dark leading-relaxed mb-5 font-light">
                Мы работаем в балинтовском формате и формате групповой супервизии. Каждая встреча — это безопасное, конфиденциальное пространство, где нет правильных ответов, но есть глубокое профессиональное присутствие.
              </p>
