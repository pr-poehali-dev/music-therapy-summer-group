...
const HERO_IMG = "https://cdn.poehali.dev/projects/7d023e65-a7ae-46f3-915e-aeca9af26149/files/91f106e1-9959-4e7e-b548-03ff5ba3ff15.jpg";
const GALLERY_IMGS = [
...
const HOSTS = [
  {
    ...
    quote: "Я с бережностью и вниманием открою себя навстречу вам, надеясь, что вместе у нас получится новая мелодия",
  ...
  },
  {
    ...
    role: "К.психол.н., супервизор, ассоциированный тренер МГИ",
    quote: "Я буду замечать тихие ноты, давать им пространство, резонируя и усиливая их звучание. Ещё я буду замечать ритмический рисунок и поддерживать выразительность именно вашей мелодии",
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {HOSTS.map((host, i) => (
              ...
              >
                {host.photo ? (
                  <div className="w-full border border-gold/30 mb-6 group-hover:border-gold/60 transition-colors">
                    <img src={host.photo} alt={host.name} className="w-full h-auto block" />
                  </div>
                ) : (
      ...
      <section id="what-inside" className="py-24 bg-charcoal">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="border border-gold/20 bg-wine/10 p-8 text-center">
            <p className="font-cormorant text-xl text-cream-light leading-relaxed italic">«Мы будем исследовать, как звучит ваша внутренняя мелодия сейчас. Без оценки "правильно/неправильно", поддерживая её уникальность. Потому что именно её звучание и есть основа вашей профессиональной устойчивости»</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="leading-relaxed mb-5 font-light text-[#e6cea6]">«Своя мелодия» — закрытая группа для практикующих психотерапевтов. Пространство, где можно услышать собственную мелодию — ту, что звучит в жизни и профессии.</p>
              <p className="text-cream-dark leading-relaxed mb-5 font-light">Наш главный инструмент — мы сами. Внутренний мир резонирует, отзывается на чужую боль, звучит в унисон с клиентом. Заботиться о нём жизненно необходимо.

Звучит ли ваша мелодия гармонично? Или в ней появились фальшивые ноты, глухие паузы? Усталость, апатия, опустошение — не поломка, а сигнал: пора позаботиться о себе.</p>
              <p className="text-cream-dark leading-relaxed font-light">До 8–10 человек. Открыта для специалистов любых направлений — психоанализ, гештальт, КПТ, экзистенциальная терапия. Важна не школа, а готовность к диалогу.</p>
            </div>
