        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-cream-dark leading-relaxed mb-5 font-light">Наш главный инструмент — мы сами. Наш внутренний психический мир настроен как музыкальный инструмент: он резонирует, отзывается на чужую боль, звучит в унисон с клиентом. Именно так мы работаем. Заботиться о нём жизненно необходимо. Звучит ли ваша мелодия гармонично? Или в ней появились фальшивые ноты, глухие паузы? Усталость, апатия, опустошение — не поломка, а сигнал: пора позаботиться о себе.</p>
              <p className="text-cream-dark leading-relaxed font-light">Группа 8–10 человек. Открыта для специалистов любых направлений — психоанализ, гештальт, КПТ, экзистенциальная терапия. Важна не школа, а готовность к диалогу.</p>
            </div>
